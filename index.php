...
if (isset($_POST['action'])) {
  switch ($_POST['action']) {
    ...
    case 'new':
      ...
      $time = time();
      if ($title && $title !== '') {
        $insertQuery = "INSERT INTO `todo` (`id`, `title`, `done`, `created_at`) VALUES (NULL, '$title', '0', CURRENT_TIMESTAMP);"; //Corrected of the insert by Helder
